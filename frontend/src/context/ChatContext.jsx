...
export const ChatProvider = ({ children }) => {
    ...
    const connect = useCallback(() => {
        ...
        const API_BASE = import.meta.env.VITE_API_URL || "https://employee-management-system-3yhf.onrender.com";
        const WS_BASE = API_BASE.replace(/^https?:\/\//, "wss://");
        const ws = new WebSocket(`${WS_BASE}/api/v1/chat/ws?token=${token}`);
